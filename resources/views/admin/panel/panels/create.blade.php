...
@section('title', 'Tambah Panel Baru')

@section('content')
<div class="content">
    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        <div>
            <h1>Tambah Panel Baru</h1>
    ...
    <form action="{{ route('admin.panel.panels.store') }}" method="POST">
        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="panel_type" class="form-select @error('panel_type') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $value }}" {{ old('panel_type') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                       value="{{ old('email') }}" placeholder="panel@syarikat.com">
                                @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card card-default mt-4">
                    ...
                    <div class="card-body">
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror"
                                  rows="3" placeholder="Nota tambahan...">{{ old('notes') }}</textarea>
                        @error('notes')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="sla_approval_days" class="form-control @error('sla_approval_days') is-invalid @enderror"
                                   value="{{ old('sla_approval_days', 7) }}" min="1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="sla_payment_days" class="form-control @error('sla_payment_days') is-invalid @enderror"
                                   value="{{ old('sla_payment_days', 14) }}" min="1">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="bi bi-check-lg me-1"></i> Simpan Panel
                            </button>
                            <a href="{{ route('admin.panel.panels.index') }}" class="btn btn-secondary">
